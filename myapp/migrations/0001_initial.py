# Generated by Django 5.1.1 on 2024-09-28 05:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('can be satisfied', 'Can be Satisfied'), ('stock not available', 'Stock Not Available')], default='can be satisfied', max_length=20)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.product')),
